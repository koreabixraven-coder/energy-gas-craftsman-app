...
- **심화종합반: 2001~2016 중복문제반** 카드를 새로 생성했습니다.
- 2001~2016년 가스기능사 **58회차 3,480문제**를 전체 비교했습니다.
- 문제문 정규화, 보기 문구 집합, 정답 문구가 모두 일치한 **실제중복 대표문제 320문제**만 탑재했습니다.
- 반복 빈도는 **5회 1문제 / 4회 6문제 / 3회 38문제 / 2회 275문제**입니다.
- 2001~2008과 2009~2016 사이에 걸쳐 반복된 **교차기간 중복 98그룹**도 포함했습니다.
- 기존 **심화중복문제(2001~2008) 178문제**, **심화중복문제(2009~2016) 157문제**는 그대로 보존했습니다.
- 전체 문제는 **6,212문제**, 전체 문제 묶음은 **169개**입니다.
- 기존 TTS, 설정, 오답노트, 암기완료, 이미지, 모바일 하단 다크 보정을 유지했습니다.
...
- 기준본: v2.85 GAS_2005_04_03_60_ANSWER_DOUBLE_CHECKED_MENU_CHAIN_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE
- 가스기능사 / 기출문제 / 2005년 10월 02일 필기 기출문제 60문제 추가
- 새 key: `가스_기출_2005_10_02`
- 전체 문제 수: 4994문제
- 교사용 PDF 각 문제의 검은 정답표시와 마지막 1~60번 정답표 대조 완료
- PDF 정답 ①②③④를 앱 내부 `ans: 0,1,2,3`으로 변환
- 신규 60문제 정답 누락 0 / 범위초과 0 / 정답표 불일치 0 / `ans: 4` 없음
- 기존 CBT 실전모의고사에 남아 있던 잘못된 `ans: 4` 24개를 앱 내부 4번 보기 인덱스인 `ans: 3`으로 안전 보정
- 전체 4,994문제의 `ans` 범위 0~3 전수검사 완료
- 원본 PDF에 별도 해설이 없어 신규 문제의 `ex`는 빈 문자열로 저장(임의 해설 미작성)
- 그림 문제 31번(KS 도시기호)과 42번(U자관)은 PDF 원본에서 잘라낸 그림을 앱 문제 카드에 함께 표시
- 화면 문제풀이 목차에 `가스_기출_2005_10_02` 연속 표시
- v2.85 기존 4934문제의 문제문·보기·해설은 유지하고, 유효 범위를 벗어난 기존 `ans: 4` 24개만 `ans: 3`으로 보정
- `questions.js?v=2.86` / `manifest.json?v=2.86` / `sw.js?v=2.86`
- Service Worker CACHE_NAME: `energy-gas-v2-86-gas-2005-10-02-60-answer-double-checked-menu-chain-hotfix-preserved-mobile-bottom-dark-safe`
- 기존 TTS / 설정창 / 오답노트 / 암기완료 / 심화중복문제 / 자동낭독 / 모바일 하단 다크 보정 유지
- `.nojekyll` 포함
...
업로드 후 GitHub Pages 배포가 완료되면 앱 주소에 `?v=2.86`를 붙여 확인합니다.

---

# energy-gas-craftsman-app v2.85
GAS_2005_04_03_60_ANSWER_DOUBLE_CHECKED_MENU_CHAIN_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE

## v2.85 변경

- 기준본: v2.84 GAS_2005_01_30_60_ANSWER_DOUBLE_CHECKED_MENU_CHAIN_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE
- 가스기능사 / 기출문제 / 2005년 04월 03일 필기 기출문제 60문제 추가
- 새 key: `가스_기출_2005_04_03`
- 전체 문제 수: 4934문제
- 교사용 PDF 각 문제의 검은 정답표시와 마지막 1~60번 정답표 대조 완료
- PDF 정답 ①②③④를 앱 내부 `ans: 0,1,2,3`으로 변환
- 신규 60문제 정답 누락 0 / 범위초과 0 / 정답표 불일치 0 / `ans: 4` 없음
- 원본 PDF에 별도 해설이 없어 신규 문제의 `ex`는 빈 문자열로 저장(임의 해설 미작성)
- 화면 문제풀이 목차에 `가스_기출_2005_04_03` 연속 표시
- v2.84 기존 4874문제와 2001년~2003년 정답 인덱스 수정 상태 유지
- `questions.js?v=2.85` / `manifest.json?v=2.85` / `sw.js?v=2.85`
- Service Worker CACHE_NAME: `energy-gas-v2-85-gas-2005-04-03-60-answer-double-checked-menu-chain-hotfix-preserved-mobile-bottom-dark-safe`
- 기존 TTS / 설정창 / 오답노트 / 암기완료 / 심화중복문제 / 자동낭독 / 모바일 하단 다크 보정 유지
- `.nojekyll` 포함
...
업로드 후 GitHub Pages 배포가 완료되면 앱 주소에 `?v=2.85`를 붙여 확인합니다.

---

# energy-gas-craftsman-app v2.84
GAS_2005_01_30_60_ANSWER_DOUBLE_CHECKED_MENU_CHAIN_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE

## v2.84 변경

- 기준본: v2.83 GAS_2004_10_10_60_ANSWER_DOUBLE_CHECKED_MENU_CHAIN_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE
- 가스기능사 / 기출문제 / 2005년 01월 30일 필기 기출문제 60문제 추가
- 새 key: `가스_기출_2005_01_30`
- 전체 문제 수: 4874문제
- 교사용 PDF 각 문제의 검은 정답표시와 마지막 1~60번 정답표 대조 완료
- PDF 정답 ①②③④를 앱 내부 `ans: 0,1,2,3`으로 변환
- 신규 60문제 정답 누락 0 / 범위초과 0 / 정답표 불일치 0 / `ans: 4` 없음
- 원본 PDF에 별도 해설이 없어 신규 문제의 `ex`는 빈 문자열로 저장(임의 해설 미작성)
- 화면 문제풀이 목차에 `가스_기출_2005_01_30` 연속 표시
- v2.83 기존 4814문제와 2001년~2003년 정답 인덱스 수정 상태 유지
- `questions.js?v=2.84` / `manifest.json?v=2.84` / `sw.js?v=2.84`
- Service Worker CACHE_NAME: `energy-gas-v2-84-gas-2005-01-30-60-answer-double-checked-menu-chain-hotfix-preserved-mobile-bottom-dark-safe`
- 기존 TTS / 설정창 / 오답노트 / 암기완료 / 심화중복문제 / 자동낭독 / 모바일 하단 다크 보정 유지
- `.nojekyll` 포함
...
업로드 후 GitHub Pages 배포가 완료되면 앱 주소에 `?v=2.84`를 붙여 확인합니다.

---

# energy-gas-craftsman-app v2.83
GAS_2004_10_10_60_ANSWER_DOUBLE_CHECKED_MENU_CHAIN_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE

## v2.83 변경

- 기준본: v2.82 GAS_2004_04_04_60_ANSWER_DOUBLE_CHECKED_2004_02_MENU_FIX_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE
- 가스기능사 / 기출문제 / 2004년 10월 10일 필기 기출문제 60문제 추가
- 새 key: `가스_기출_2004_10_10`
- 전체 문제 수: 4814문제
- 교사용 PDF 각 문제의 검은 정답표시와 마지막 1~60번 정답표 대조 완료
- PDF 정답 ①②③④를 앱 내부 `ans: 0,1,2,3`으로 변환
- 신규 60문제 정답 누락 0 / 범위초과 0 / 정답표 불일치 0 / `ans: 4` 없음
- 원본 PDF에 별도 해설이 없어 신규 문제의 `ex`는 빈 문자열로 저장(임의 해설 미작성)
- 화면 문제풀이 목차에 빠져 있던 `가스_기출_2004_04_04`를 보완하고 `가스_기출_2004_10_10`도 연속 표시
- v2.82 기존 4754문제와 2001년~2003년 정답 인덱스 수정 상태 유지
- `questions.js?v=2.83` / `manifest.json?v=2.83` / `sw.js?v=2.83`
- Service Worker CACHE_NAME: `energy-gas-v2-83-gas-2004-10-10-60-answer-double-checked-menu-chain-hotfix-preserved-mobile-bottom-dark-safe`
- 기존 TTS / 설정창 / 오답노트 / 암기완료 / 심화중복문제 / 자동낭독 / 모바일 하단 다크 보정 유지
- `.nojekyll` 포함
...
업로드 후 GitHub Pages 배포가 완료되면 앱 주소에 `?v=2.83`을 붙여 확인합니다.

---

# energy-gas-craftsman-app v2.82
GAS_2004_04_04_60_ANSWER_DOUBLE_CHECKED_2004_02_MENU_FIX_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE

## v2.82 변경

- 기준본: v2.81 GAS_2004_02_01_60_ANSWER_DOUBLE_CHECKED_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE
- 가스기능사 / 기출문제 / 2004년 04월 04일 필기 기출문제 60문제 추가
- 새 key: `가스_기출_2004_04_04`
- 전체 문제 수: 4754문제
- 교사용 PDF 각 문제의 검은 정답표시와 마지막 1~60번 정답표 대조 완료
- PDF 정답 ①②③④를 앱 내부 `ans: 0,1,2,3`으로 변환
- 신규 60문제 정답 누락 0 / 범위초과 0 / 정답표 불일치 0 / `ans: 4` 없음
- v2.81에서 DB에는 있었으나 화면 문제풀이 목차에 빠졌던 `가스_기출_2004_02_01` 표시를 함께 보완
- v2.81 기존 4694문제와 2001년~2003년 정답 인덱스 수정 상태 유지
- `questions.js?v=2.82` / `manifest.json?v=2.82` / `sw.js?v=2.82`
- Service Worker CACHE_NAME: `energy-gas-v2-82-gas-2004-04-04-60-answer-double-checked-2004-02-menu-fix-hotfix-preserved-mobile-bottom-dark-safe`
- 기존 TTS / 설정창 / 오답노트 / 암기완료 / 심화중복문제 / 자동낭독 / 모바일 하단 다크 보정 유지
- 원본 PDF에 별도 해설이 없어 해설란은 `해설 원문: PDF에 별도 해설 원문 없음`으로 표시
- `.nojekyll` 포함
...
업로드 후 GitHub Pages 배포가 완료되면 앱 주소에 `?v=2.82`를 붙여 확인합니다.

---

# energy-gas-craftsman-app v2.81
GAS_2004_02_01_60_ANSWER_DOUBLE_CHECKED_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE

## v2.81 변경

- 기준본: v2.80 GAS_2003_10_05_60_ANSWER_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE
- 가스기능사 / 기출문제 / 2004년 02월 01일 필기 기출문제 60문제 추가
- 새 key: `가스_기출_2004_02_01`
- 전체 문제 수: 4694문제
- 교사용 PDF 각 문제의 검은 정답표시와 마지막 1~60번 정답표 대조 완료
- PDF 정답 ①②③④를 앱 내부 `ans: 0,1,2,3`으로 변환
- 신규 60문제 정답 누락 0 / 범위초과 0 / 정답표 불일치 0 / `ans: 4` 없음
- v2.80의 2001년~2003년 정답 인덱스 수정 상태와 2003년 10월 05일 회차 유지
- `questions.js?v=2.81` / `manifest.json?v=2.81` / `sw.js?v=2.81`
- Service Worker CACHE_NAME: `energy-gas-v2-81-gas-2004-02-01-60-answer-double-checked-hotfix-preserved-mobile-bottom-dark-safe`
- 기존 TTS / 설정창 / 오답노트 / 암기완료 / 심화중복문제 / 자동낭독 / 모바일 하단 다크 보정 유지
- 원본 PDF에 별도 해설이 없어 해설란은 `해설 원문: PDF에 별도 해설 원문 없음`으로 표시
- `.nojekyll` 포함
...
업로드 후 GitHub Pages 배포가 완료되면 앱 주소에 `?v=2.81`을 붙여 확인합니다.

---

# energy-gas-craftsman-app v2.80
GAS_2003_10_05_60_ANSWER_HOTFIX_PRESERVED_MOBILE_BOTTOM_DARK_SAFE

## v2.80 변경

- 기준본: v2.79 GAS_2001_2003_ANSWER_INDEX_HOTFIX_MOBILE_BOTTOM_DARK_SAFE
- 가스기능사 / 기출문제 / 2003년 10월 05일 필기 기출문제 60문제 추가
- 새 key: `가스_기출_2003_10_05`
- 전체 문제 수: 4634문제
- 교사용 PDF 본문 정답 표시와 마지막 60문제 정답표 대조 완료
- 신규 60문제 정답 누락 0 / 범위초과 0 / 정답표 불일치 0
- v2.79에서 바로잡은 2001년 04월 29일~2003년 03월 30일 8개 회차 480문제 정답 인덱스 수정 상태 유지
- `questions.js?v=2.80` / `manifest.json?v=2.80` / `sw.js?v=2.80`
- Service Worker CACHE_NAME: `energy-gas-v2-80-gas-2003-10-05-60-answer-hotfix-preserved-mobile-bottom-dark-safe`
- 기존 TTS / 설정창 / 오답노트 / 암기완료 / 심화중복문제 / 자동낭독 / 모바일 하단 다크 보정 유지
- 원본 PDF에 별도 해설이 없어 해설란은 `해설 원문: PDF에 별도 해설 원문 없음`으로 표시
- `.nojekyll` 포함
...
업로드 후 GitHub Pages 배포가 완료되면 앱 주소에 `?v=2.80`을 붙여 확인합니다.
