// v2.35: 에너지관리기능사 심화학습 중복문제 3카드 추가 + 캐시 강제 갱신.
const CACHE_NAME = 'energy-gas-v2-35-cbt-past-duplicate-deep-learning-cache-menu-strict-original-ex';
const ASSETS = [
  './',
  './index.html?v=2.35',
  './manifest.json?v=2.35',
  './questions.js?v=2.35',
  './theory.js?v=2.35',
  './sw.js?v=2.35',
  './icon-72.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    for (const client of clientList) {
      client.postMessage({type: 'SW_UPDATED', version: 'v2.35'});
    }
  })());
});
...
async function networkFirst(req) {
  try {
    ...
    return caches.match('./index.html?v=2.35') || caches.match('./index.html') || Response.error();
  }
}
