// v2.66: 2016년 3회 기출 60문제 추가 + 모바일 하단 다크 보정 유지 + 캐시 강제 갱신.
const CACHE_NAME = 'energy-gas-v2-66-gas-2016-3-60-mobile-bottom-dark-safe';
const ASSETS = [
  './',
  './index.html?v=2.66',
  './manifest.json?v=2.66',
  './questions.js?v=2.66',
  './theory.js?v=2.66',
  './sw.js?v=2.66',
  './icon-72.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    for (const client of clientList) {
      client.postMessage({type: 'SW_UPDATED', version: 'v2.66'});
    }
  })());
});
...
async function networkFirst(req) {
  try {
    ...
    return caches.match('./index.html?v=2.66') || caches.match('./index.html') || Response.error();
  }
}
